# Generated by Django 2.1.5 on 2019-04-03 20:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_code', models.CharField(max_length=250, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('canvas_instance', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='canvas', to='course.CanvasSite')),
