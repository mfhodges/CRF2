# Generated by Django 2.1.5 on 2019-06-26 19:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sis_course_id', models.CharField(default=None, max_length=50)),
                ('sis_section_id', models.CharField(default=None, max_length=50)),
                ('section_name', models.CharField(default=None, max_length=50)),
                ('subaccount', models.CharField(default=None, max_length=50)),
                ('term', models.CharField(default=None, max_length=5)),
                ('added_permissions', models.ManyToManyField(blank=True, default=None, related_name='Canvas_Site_Permissions', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('copy_from_course', models.CharField(default=None, max_length=100, null=True)),
                ('title_override', models.CharField(default=None, max_length=100, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.Activity'),
        ),
        migrations.AddField(
            model_name='course',
        ...
        migrations.AddField(
            model_name='course',
            name='owner',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='created', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='autoadd',
            name='school',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='course.Request'),
        ),
        migrations.AddField(
