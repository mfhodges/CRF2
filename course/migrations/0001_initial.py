# Generated by Django 2.1.5 on 2019-04-16 20:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_enrollments', models.ManyToManyField(blank=True, related_name='additional_enrollments', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.Request'),
        ),
    ]
